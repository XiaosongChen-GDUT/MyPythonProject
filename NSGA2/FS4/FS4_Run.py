...
from NSGA2.FS4.FS4_Evolution import Evolution
from NSGA2.FS4.FS4_Problem import Problem
...
if __name__ == '__main__':
    ...
    evo = Evolution(
        ...
        crossover_type="crossover", # two_point两点交叉      order 顺序交叉  pmx部分交叉   sbx模拟二进制交叉
        mutation_type="mutpolyn",       # swap交换变异    shuffle打乱变异  inversion反转变异     mutpolyn多项式变异  mutate10%打乱变异
        init_type="random",
        )
    ...
    try:
        ...
        FS_Utils.save_pareto_front(front=front ,true_pf_file="pareto_fronts.csv",run_id=1)
        # 提取 Pareto 前沿的目标值
